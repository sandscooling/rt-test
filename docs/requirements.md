...
- FR2: Record each run's test outcomes, skips, collection errors, module and run-level errors, worker crashes, and interruptions as distinct states. [Ticket 1.1b]
